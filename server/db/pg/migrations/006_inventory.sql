CREATE TABLE IF NOT EXISTS inventory_items (
  ...
  unit TEXT NOT NULL,
  minimum_stock DOUBLE PRECISION CHECK (minimum_stock IS NULL OR minimum_stock >= 0),
...
CREATE TABLE IF NOT EXISTS inventory_movements (
  ...
  unit TEXT NOT NULL,
  unit_cost DOUBLE PRECISION CHECK (unit_cost IS NULL OR unit_cost >= 0),
  total_cost DOUBLE PRECISION CHECK (total_cost IS NULL OR total_cost >= 0),
  supplier TEXT,
  notes TEXT,
